describe('Midas.Modal', function() {
  ...
  pending('handles width as an option', function() {
    ...
    runs(function() {
      expect(this.modal.frameElement.getWidth()).toEqual(800);
    });
  });
  ...
  pending('updates the content', function() {

  });

  pending('hides on escape key', function() {

  });

  pending('hides when the close button is pressed', function() {

  });

  pending('loads contents from a url', function() {
