...
Officially supported browsers are Firefox 3.6+, Safari 4.0+, and Chrome (it would seem all versions).
...
The project is basically broken into three parts.. Javascript, the rake tasks, and rails stuff.
