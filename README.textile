...
The project is basically broken into three parts.. Javascript, the HTML views (palettes, panels etc), and the rake tasks.  To get started run @gem install bundler@, and then @bundle install@, which will give you all the gems you'll need for testing etc.
